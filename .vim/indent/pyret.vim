...
let s:pyretIndentOpeners = '^\s*\(check\|data\|for\|fun\|if\|else\|elseif\|case\|while\|switch\|try\|otherwise\|catch\)\>'

let s:pyretIndentClosers = '^\s*\(end\|else\|elseif\|case\|otherwise\|catch\)\>'
