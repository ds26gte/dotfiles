...
let s:juliaIndentOpeners = '^\s*\(for\|function\|if\|else\|elseif\|case\|while\|switch\|try\|otherwise\|catch\)\>'

let s:juliaIndentClosers = '^\s*\(end\|else\|elseif\|case\|otherwise\|catch\)\>'
